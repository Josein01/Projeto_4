...
def registrar_usuario():
    # --- MOCK ---
    # Apenas recebemos os dados e retornamos sucesso.
...
def login():
    # --- MOCK ---
    # Aceita qualquer e-mail/senha e retorna um token JWT válido.
    dados = request.get_json()
    ...
    # Cria um token válido usando o e-mail como identidade.
...
def simular_investimento_cdb():
    # Esta rota continua funcionando, pois valida o token gerado pelo login mockado.
    usuario_logado = get_jwt_identity()
    print(f"DEBUG: Simulação pedida pelo usuário mockado: {usuario_logado}")
