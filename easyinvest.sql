...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`usuario` ;
...
-- -----------------------------------------------------
-- Table `sakila`.`indicadores`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`indicadores` ;

CREATE TABLE IF NOT EXISTS `sakila`.`indicadores` (
  ...
  INDEX `fk_indicadores_usuario1_idx` (`usuario_idusuario` ASC),
  CONSTRAINT `fk_indicadores_usuario1`
    FOREIGN KEY (`usuario_idusuario`)
    REFERENCES `sakila`.`usuario` (`idusuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `sakila`.`investimento`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`investimento` ;

CREATE TABLE IF NOT EXISTS `sakila`.`investimento` (
